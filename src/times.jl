...
(
    times(model::OptimalControlModel{T,S,C,V,D,O})::T
) where {
...
(
    initial_time(model::OptimalControlModel{T,S,C,V,D,O})::Time
) where {
    ...
    D<:Function,
    O<:AbstractObjectiveModel,
} = initial_time(times(model))

(
    final_time(model::OptimalControlModel{T,S,C,V,D,O})::Time
) where {
    ...
    D<:Function,
    O<:AbstractObjectiveModel,
} = final_time(times(model))

(
    initial_time(model::OptimalControlModel{T,S,C,V,D,O}, variable::Variable)::Time
) where {
    ...
    D<:Function,
    O<:AbstractObjectiveModel,
} = initial_time(times(model), variable)

(
    final_time(model::OptimalControlModel{T,S,C,V,D,O}, variable::Variable)::Time
) where {
    ...
    D<:Function,
    O<:AbstractObjectiveModel,
} = final_time(times(model), variable)
...
(
    has_fixed_initial_time(model::OptimalControlModel{T,S,C,V,D,O})::Bool
) where {
    T<:TimesModel{FixedTimeModel,<:AbstractTimeModel},
    S<:AbstractStateModel,
    C<:AbstractControlModel,
...
(
    has_fixed_final_time(model::OptimalControlModel{T,S,C,V,D,O})::Bool
) where {
    T<:TimesModel{<:AbstractTimeModel,FixedTimeModel},
    S<:AbstractStateModel,
    C<:AbstractControlModel,
