...
Pack local variables into a [`PreModel`](@ref) object.
...
See also: [`@unpack_PreModel`](@ref), [`@pack_PreModel!`](@ref).
"""
:var"@pack_PreModel"
...
Pack local variables into an existing [`PreModel`](@ref) object in-place.

Generated by `Parameters.@with_kw` for the mutable `PreModel` type.

See also: [`@pack_PreModel`](@ref), [`@unpack_PreModel`](@ref).
"""
:var"@pack_PreModel!"
...
Unpack fields from a [`PreModel`](@ref) object into local variables.
