...
The expression is wrapped in a [`CTModels.Components.Definition`](@extref) and stored on the pre-model.
...
[`CTModels.Components.AbstractDefinition`](@extref) value (either a [`CTModels.Components.Definition`](@extref) or an
[`CTModels.Components.EmptyDefinition`](@extref)).
