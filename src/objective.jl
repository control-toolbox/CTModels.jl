...
(
    objective(model::OptimalControlModel{T,S,C,V,D,O})::O
) where {
...
(
    mayer(model::OptimalControlModel{T,S,C,V,D,MayerObjectiveModel{M}})::M
) where {
    T<:AbstractTimesModel,
    S<:AbstractStateModel,
    C<:AbstractControlModel,
    ...
    D<:Function,
    M<:Function,
} = mayer(objective(model))
(
    mayer(model::OptimalControlModel{T,S,C,V,D,BolzaObjectiveModel{M,L}})::M
) where {
    T<:AbstractTimesModel,
    S<:AbstractStateModel,
    C<:AbstractControlModel,
...
function mayer(
    model::OptimalControlModel{T,S,C,V,D,<:LagrangeObjectiveModel}
) where {
    T<:AbstractTimesModel,
    S<:AbstractStateModel,
    C<:AbstractControlModel,
...
(
    lagrange(model::OptimalControlModel{T,S,C,V,D,LagrangeObjectiveModel{L}})::L
) where {
    T<:AbstractTimesModel,
    S<:AbstractStateModel,
    C<:AbstractControlModel,
    ...
    D<:Function,
    L<:Function,
} = lagrange(objective(model))
(
    lagrange(model::OptimalControlModel{T,S,C,V,D,BolzaObjectiveModel{M,L}})::L
) where {
    T<:AbstractTimesModel,
    S<:AbstractStateModel,
    C<:AbstractControlModel,
...
function lagrange(
    model::OptimalControlModel{T,S,C,V,D,<:MayerObjectiveModel}
) where {
    T<:AbstractTimesModel,
    S<:AbstractStateModel,
    C<:AbstractControlModel,
