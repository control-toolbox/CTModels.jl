function test_initial_guess_types()
    ...
    Test.@testset "OptimalControlInitialGuess structure" verbose=VERBOSE showtiming=SHOWTIMING begin
        state_fun = t -> [t]
        control_fun = t -> [-t]
    ...
    Test.@testset "fake consumer of OptimalControlInitialGuess" verbose=VERBOSE showtiming=SHOWTIMING begin
        state_fun = t -> 2t
        control_fun = t -> -3t
        variable_val = 1.23
