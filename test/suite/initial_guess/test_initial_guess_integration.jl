...
function test_initial_guess_integration()
    ...
    Test.@testset "Beam problem - NamedTuple initialization" verbose=VERBOSE showtiming=SHOWTIMING begin
        beam_data = Beam()
        ocp = beam_data.ocp
    ...
    Test.@testset "Beam problem - function-based initialization" verbose=VERBOSE showtiming=SHOWTIMING begin
        beam_data = Beam()
        ocp = beam_data.ocp
    ...
    Test.@testset "Beam problem - time-grid initialization" verbose=VERBOSE showtiming=SHOWTIMING begin
        beam_data = Beam()
        ocp = beam_data.ocp
    ...
    Test.@testset "Beam problem - PreInit workflow" verbose=VERBOSE showtiming=SHOWTIMING begin
        beam_data = Beam()
        ocp = beam_data.ocp
    ...
    Test.@testset "Beam problem - complete workflow with all features" verbose=VERBOSE showtiming=SHOWTIMING begin
        beam_data = Beam()
        ocp = beam_data.ocp
