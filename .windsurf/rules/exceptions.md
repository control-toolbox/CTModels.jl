...
# Julia Exception Handling Standards

This document defines exception handling standards for CTModels. Use the enriched `Exceptions` module, not CTBase exceptions directly.
